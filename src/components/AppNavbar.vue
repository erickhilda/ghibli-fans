<template>
  <header class="bg-gray-800 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
    <div class="flex items-center justify-between px-4 py-3 sm:p-0">
      ...
      <div class="sm:hidden">
        <button id="menu-burger" aria-label="menu-burger" @click="isOpen = !isOpen" type="button" class="block text-gray-500 focus:text-white focus:outline-none">
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4 sm:flex sm:p-0">
      <a href="#" class="block px-2 py-1 text-white font-semibold rounded">
